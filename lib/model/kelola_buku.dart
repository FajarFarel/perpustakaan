...
class _KelolaBukuState extends State<KelolaBuku> {
  ...
  void _showForm({ModelBuku? buku}) {
    ...
    final noBukuController = TextEditingController(text: buku?.no_buku ?? '');
    final jumlahController =
        TextEditingController(text: buku?.jumlah.toString() ?? '');
    final deskripsiController =
        TextEditingController(text: buku?.deskripsi ?? '');
            ...
            children: [
              ...
              ElevatedButton.icon(
                onPressed: () => _showImageSourceDialog(
                    context), // Pindah ke fungsi terpisah
        ...
        return Container(
            ...
            child: GridView.builder(
              ...
              gridDelegate: const SliverGridDelegateWithFixedCrossAxisCount(
                ...
                childAspectRatio: 0.7, // Diperkecil dari 3/4 menjadi 0.7
              ),
              itemCount: books.length,
              itemBuilder: (context, index) {
                final buku = books[index];
                return GestureDetector(
                  // Di dalam itemBuilder GridView.builder, ubah bagian showDialog menjadi:
                  onTap: () => showDialog(
                    context: context,
                    builder: (context) {
                      return Dialog(
                              ...
                              children: [
                                ...
                                Center(
                                  child: SizedBox(
                                    ...
                                    child: buku.fotoBase64 != null
                                        ? ClipRRect(
                                            borderRadius:
                                                BorderRadius.circular(8),
                                            child: Image.memory(
                                              base64Decode(buku.fotoBase64!),
                                              fit: BoxFit.cover,
                                            ),
                                          )
                                        : Container(
